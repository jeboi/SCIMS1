...
export default function LogisticsAnalytics({ data, loading }) {
    if (loading) {
        return (
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-4">
                ...
                <div className="bg-white rounded-xl border p-4 text-center">
                    ...
                    <p className="text-xl font-bold text-blue-600">{summary.in_transit || 0}</p>
                </div>
                <div className="bg-white rounded-xl border p-4 text-center">
                ...
                <div className="bg-white rounded-xl border p-4 text-center">
                    ...
                    <p className="text-xl font-bold text-purple-600">{summary.on_time_rate || 0}%</p>
                </div>
            </div>
                    ...
                    <div className="h-64">
                        <ResponsiveContainer width="100%" height="100%">
                            <BarChart data={data.deliveryPerformance || []}>
                                ...
                                <Tooltip />
                                <Legend />
                                <Bar dataKey="on_time" fill="#22c55e" name="On-Time" />
